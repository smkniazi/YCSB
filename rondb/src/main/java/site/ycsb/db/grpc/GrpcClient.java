...
public final class GrpcClient extends DB {
  ...
  private void test() throws DBException {
    blockingStub.stat(StatRequestProto.newBuilder().build());
  }
  ...
  public Status read(String table, String key, Set<String> fields, Map<String, ByteIterator> result) {
    ...
    PKReadResponseProto response = blockingStub.pKRead(pkRead);
  ...
  public Status batchRead(String table, List<String> keys, List<Set<String>> fields,
    ...
    BatchRequestProto.Builder batchReqBuilder =
        BatchRequestProto.newBuilder();
    ...
    BatchResponseProto response = blockingStub.batch(batchReqBuilder.build());
    if (response == null || !response.isInitialized()) {
      return Status.ERROR;
    }
